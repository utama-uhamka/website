    ...
    },
    {
      ...
      render: (value) => (
        <span className={`inline-flex items-center whitespace-nowrap px-2.5 py-1 rounded-full text-xs font-medium ${
          ...
          value === 'Diperbaiki' ? 'bg-green-100 text-green-700' :
          value === 'Maintenance' ? 'bg-blue-100 text-blue-700' :
          value === 'Baik' ? 'bg-emerald-100 text-emerald-700' :
                      ...
                      <div className="flex flex-wrap gap-4 text-xs text-gray-500">
                        ...
                        <div className="flex items-center gap-1">
                          <span className={`inline-flex items-center whitespace-nowrap px-2 py-0.5 rounded text-xs font-medium ${
                            issue.item_condition === 'Rusak' ? 'bg-red-100 text-red-700' :
                            issue.item_condition === 'Menunggu Diperbaiki' ? 'bg-yellow-100 text-yellow-700' :
                            issue.item_condition === 'Diperbaiki' ? 'bg-green-100 text-green-700' :
                            issue.item_condition === 'Maintenance' ? 'bg-blue-100 text-blue-700' :
                            issue.item_condition === 'Baik' ? 'bg-emerald-100 text-emerald-700' :
                            'bg-gray-100 text-gray-700'
                          }`}>
