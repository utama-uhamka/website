...
import { FiPlus, FiEdit2, FiTrash2, FiSearch, FiFilter, FiDownload, FiZap } from 'react-icons/fi';
import PLNModal from './PLNModal';

const PLNBilling = () => {
  const [billings, setBillings] = useState([
    { id: 1, campus: 'Campus Pusat', meter: 'PLN-001', month: 'November 2024', usage: 5500, rate: 2000, total: 11000000, status: 'Paid', dueDate: '2024-11-30', paymentDate: '2024-11-28' },
    { id: 2, campus: 'Campus Bandung', meter: 'PLN-002', month: 'November 2024', usage: 3200, rate: 2000, total: 6400000, status: 'Pending', dueDate: '2024-11-30', paymentDate: null },
    { id: 3, campus: 'Campus Pusat', meter: 'PLN-001', month: 'October 2024', usage: 5200, rate: 2000, total: 10400000, status: 'Paid', dueDate: '2024-10-31', paymentDate: '2024-10-30' },
    { id: 4, campus: 'Campus Jakarta', meter: 'PLN-003', month: 'November 2024', usage: 4800, rate: 2000, total: 9600000, status: 'Overdue', dueDate: '2024-11-15', paymentDate: null },
  ]);
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="text-left py-4 px-6 font-semibold text-gray-700">Penggunaan (kWh)</th>
